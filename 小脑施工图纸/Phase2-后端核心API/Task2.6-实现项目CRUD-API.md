...
## 当前任务：Task2.6-实现项目CRUD-API

**目标：** POST /api/projects新建、GET /api/projects列表、GET /api/projects/{id}详情含step_outputs、DELETE /api/projects/{id}，Service层edited_output→ai_output fallback
