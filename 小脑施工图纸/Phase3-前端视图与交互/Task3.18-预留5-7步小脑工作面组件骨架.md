...
## 当前任务：Task3.18-预留5-7步小脑工作面组件骨架

**目标：** CerebellumWriteWorkspace(步骤5)、CerebellumDebugWorkspace(步骤6)、CerebellumTestWorkspace(步骤7)，仅搭建组件结构+路由守卫，is_active=False时不渲染
